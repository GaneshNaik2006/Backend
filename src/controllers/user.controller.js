...
const loginUser = asyncHandler(async (req, res) => {
    ...
    if (!checkPassword) throw new ApiError(404, 'Invalid credentials');
...
const changeCurrentPassword = asyncHandler(async (req, res) => {
    ...
    if (!ispasswordCorrect) throw new ApiError(400, "incoorect password");
    user.password = newPassword
    await user.save({ validateBeforeSave: false })
    
    return res.status(200)
        .json(new ApiResponse(200, {}, "password is successfully updated"));
...
const updateAccountDetails = asyncHandler(async (req, res) => {
    ...
    res.status(200)
    .json(new ApiResponse(200,user,"succesfully account details updated "))
...
const updateUserAvatar = asyncHandler(async (req, res) => {
    ...
    if (!avatar.url) throw new ApiError(400, "error while upploading avatar");
//TODO:DELETE OLD FILE
    ...
    return res.status(200).
        json(new ApiResponse(200, {user}, "succesfully updated useravtar"));
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
    ...
    if (!coverImage.url) throw new ApiError(400, "error while upploading avatar");
   ...
   const user= await User.findByIdAndUpdate(
    ...
    return res.status(200).
        json(new ApiResponse(200, {user}, "succesfully updated user coverIamge"));
